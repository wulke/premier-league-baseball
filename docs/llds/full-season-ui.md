...
> Depends on: `docs/llds/bracket-api.md` (`GetLeagueBracket` response shape), `docs/llds/simulate-game-ui.md` (existing `GameWorldProvider`/`AppHeader`/`refreshToken` patterns this extends)
