...
> Depends on: `docs/llds/league/knockout-bracket.md` (data shape), `docs/llds/game-world/full-season-ui.md` (`BracketView` render-shape contract, #39)
...
`BracketRound` / `BracketTie` / `BracketGame` are the render-shape `docs/llds/game-world/full-season-ui.md`
...
| **This LLD** | `docs/llds/league/bracket-api.md` |
| EARS | `docs/specs/league/bracket-api-specs.md` — `API-001`.. |
