...
> Depends on: `docs/llds/league/competition-format.md` (`CompetitionFormat.tiebreak`/`seeding`)
...
division decides (`docs/llds/game-world/full-season-ui.md`, #40). One row per `(divisionId, year)`.
...
| **This LLD** | `docs/llds/league/knockout-bracket.md` |
| EARS | `docs/specs/league/league-cup-specs.md` — `CUP-001`.. |
