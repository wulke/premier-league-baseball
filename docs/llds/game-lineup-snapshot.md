...
> Upstream: [`lineup-generation.md`](./lineup-generation.md) · EARS: `docs/specs/game-lineup-snapshot-specs.md` (`LSNAP-001`..`LSNAP-004`) · Decision record: #138 / issue #201.

## Interface / Data Model

```ts
TeamFactory(teamId).snapshotForGame(gameId): Promise<Lineup>
