...
| Backend sibling LLD | `docs/llds/manager/roster-read-api.md` |
| **This LLD** | `docs/llds/manager/team-roster-ui.md` |
| Sibling UI LLD | `docs/llds/player/player-detail-ui.md` (roster row links here) |
| EARS | `docs/specs/manager/team-roster-ui-specs.md` — `ROSTUI-001`.. |
