...
| **This LLD** | `docs/llds/manager/roster-read-api.md` |
| Sibling LLDs | `docs/llds/player/player-identity.md` (identity columns), `docs/llds/player/player-detail-read-api.md` (Contract DATE), `docs/llds/manager/team-roster-ui.md` (consumer), `docs/llds/manager/lineup-view-ui.md` (consumer of the #225 `positions` amendment) |
| EARS | `docs/specs/manager/roster-read-api-specs.md` — `ROST-001`.. |
