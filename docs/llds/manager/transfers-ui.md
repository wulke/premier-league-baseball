...
> Amends: `docs/llds/manager/team-roster-ui.md` (adds release/renew row actions), `src/ui/components/nav-rail.tsx` (un-dims the Transfers fog item)
...
| **This LLD** | `docs/llds/manager/transfers-ui.md` |
| Backend sibling LLD | `docs/llds/player/contract-lifecycle.md` |
| Amends | `docs/llds/manager/team-roster-ui.md` (release/renew row actions), `docs/llds/shell/app-shell-ui.md`/`docs/llds/manager/managed-club-ui.md` (nav-rail fog trio) |
| EARS | `docs/specs/manager/transfers-ui-specs.md` — `XFERUI-001`.. |
