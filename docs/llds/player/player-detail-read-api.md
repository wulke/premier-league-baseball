...
### Contract schema migration (amends `docs/llds/player/player-contracts-roster.md` / `PCON` territory)
...
| **This LLD** | `docs/llds/player/player-detail-read-api.md` |
| Amends | `docs/llds/player/player-contracts-roster.md` (Contract INT→DATE) |
| Sibling LLDs | `docs/llds/player/player-identity.md` (writes the new DATE columns), `docs/llds/manager/roster-read-api.md` (joins on them), `docs/llds/player/player-detail-ui.md` (consumer) |
| EARS | `docs/specs/player/player-detail-read-api-specs.md` — `PDET-001`.. |
