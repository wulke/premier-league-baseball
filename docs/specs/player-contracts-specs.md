...
| PCON-008 | WHEN the database models initialize THE system SHALL define a `Contract` model with `playerId`, `teamId`, `startYear`, and `endYear`, and SHALL NOT define a salary or `value` field in v1 | [x] → #73 |
