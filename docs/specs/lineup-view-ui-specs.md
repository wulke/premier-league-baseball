...
| LINEUI-011 | WHEN a starter is displayed in edit mode THE system SHALL derive its batting slot without allowing it to be edited; the pitcher SHALL be locked to 9 when DH is disabled and SHALL have no batting slot when DH is enabled. | [x] → #255 |
