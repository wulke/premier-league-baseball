...
| SIM-020 | WHEN the player triggers Simulate Today IF a reachable non-COMPLETED game scheduled on or before currentDate remains after batch simulation THE system SHALL leave currentDate unchanged and return nextDate null | [x] → #293 |
