...
| SIM-020 | WHEN the player triggers Simulate Today IF a reachable non-COMPLETED non-SCHEDULED game scheduled on or before currentDate remains after batch simulation THE system SHALL leave currentDate unchanged and return nextDate null with progressBlocked true | [ ] → #293 |
