...
| PDETUI-007 | WHEN the Positions tab is selected THE system SHALL offer a view-switcher across field diagram, bar grid, and coverage pills, all derived from the 9-key `positions` map | [x] → #172 |
